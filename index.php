...
$APPLICATION->SetPageProperty("title", "Интернет-магазин конструкторов и развивающих игрушек для детей");
$APPLICATION->SetTitle("Eco Puzzles - интернет-магазин игрушек для детей.");?> <?
	//include module
...
);?> <?$APPLICATION->IncludeComponent("dresscode:offers.product", ".default", array(
	"CACHE_TIME" => "3600000",
		"CACHE_TYPE" => "Y",
		"COMPONENT_TEMPLATE" => ".default",
		"ELEMENTS_COUNT" => "5",

<?
$MESS["skyweb24.popuppro_PARTNER_NAME"] = "Скайвеб24";
$MESS["skyweb24.popuppro_MODULE_NAME"] = 'Всплывающие окна PRO';
$MESS["skyweb24.popuppro_MODULE_DESCRIPTION"] = 'Модуль «Всплывающие окна PRO» - позволяет создавать на Вашем сайте неограниченное число всплывающих окон, которые позволят Вам решать всевозможные задачи.';
$MESS["skyweb24.popuppro_PARTNER_URI"] = 'http://skyweb24.ru';
$MESS['skyweb24.popuppro_EVENT_NAME']='Отправка купона';
$MESS['skyweb24.popuppro_EVENT_NAME_ROULETTE']='Отправка результата рулетки';
$MESS['skyweb24.popuppro_EVENT_DESCRIPTION']='#EMAIL# - Email
#COUPON# - Купон';

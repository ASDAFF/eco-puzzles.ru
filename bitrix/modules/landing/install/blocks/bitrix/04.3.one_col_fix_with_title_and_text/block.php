    <section class="landing-block js-animation slideInRight g-theme-business-bg-blue-dark-v1 g-pt-20 g-pb-20">
        ...
        <div class="container text-center g-max-width-800 g-color-gray-light-v2">
			...
			<div class="landing-block-node-text g-color-gray-light-v2 g-pb-1">

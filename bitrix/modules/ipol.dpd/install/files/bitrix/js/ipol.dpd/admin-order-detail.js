...
DpdOrderDetailHelper.prototype.initEvents = function()
{
	...
	BX.bind(BX('IPOLH_DPD_ORDER_PAYMENT_TYPE'),               'change', BX.proxy(this.recalculate, this));
	BX.bind(BX('IPOLH_DPD_ORDER_SUM_NPP'),                    'change', BX.proxy(this.recalculate, this));
	BX.bind(BX('IPOLH_DPD_ORDER_FORM').querySelector('form'), 'submit', function(e) {
		return BX.PreventDefault(e);
	});

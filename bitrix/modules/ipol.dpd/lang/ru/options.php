...
$MESS["IPOLH_DPD_OPTIONS_TAB_COMMON_HELP"] = "Получить ключ интеграции вы можете пройдя по ссылке <a href=\"http://www.dpd.ru/ols/order/personal/integrationkey.do2\">http://www.dpd.ru/ols/order/personal/integrationkey.do2</a> в личном кабинете MyDPD или обратившись в службу поддержки на email itcustomers@dpd.ru";
...
/* Tab 4 */
$MESS["IPOLH_DPD_OPTIONS_TAB_CALCULATE"] = "Рассчет доставки";
$MESS["IPOLH_DPD_OPTIONS_TAB_CALCULATE_TITLE"] = "Настройки рассчета доставки";
...
$MESS["IPOLH_DPD_OPTIONS_DELIVERY_TIME_PERIOD_18_22"] = "с 18:00 да 22:00 (оплачивается дополнительно)";
...
$MESS["IPOLH_DPD_OPTIONS_DVD_HELP"] = "Эта опция, позволяющая осуществить доставку отправки получателю в соответствии со сроком доставки ТК, но раньше даты, рассчитанной по стандартным правилам, при условии, что итоговая дата доставки придется на выходной день";
...
Данная группа настроек предназначена для определения габаритов тех заказов, где присутствуют товары без заполненных размеров и/или веса. Здесь можно задать те значения, что будут браться по умолчанию для всего заказа.
<br><br>
...
$MESS["IPOLH_DPD_OPTIONS_TAB_STATUS_HELP"] = "
	...
	<br><br>
	<b style=\"color:red\">Внимание!</b> Для возможности отслеживания статусов посылок DPD Вам необходимо сделать запрос к сотруднику 
	DPD на сайте <a href=\"http://dpd.ru/\" target=\"_blank\">dpd.ru</a>, для этого напишите ему: 
	\"<i>Для работы с методом getStatesByClient подключите нам услугу отслеживания посылок с подтверждением</i>\"
";
...
$MESS["IPOLH_DPD_OPTIONS_STATUS_ORDER_READY"] = "Статус заказа, готового к выдачи (на пункте или к передаче курьеру)";

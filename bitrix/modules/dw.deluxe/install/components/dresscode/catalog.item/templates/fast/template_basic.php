			...
			<div class="appFastViewColumnContainer">
				...
				<div class="appFastViewInformationColumn">
					...
					<div class="catalogQtyBlock">
			            <label class="label"><?=GetMessage("FAST_VIEW_QUANTITY_LABEL")?> </label> <a href="#" class="catalogMinus"></a><input type="text" class="catalogQty" value="<?=$arResult["EXTRA_SETTINGS"]["BASKET_STEP"]?>" data-step="<?=$arResult["EXTRA_SETTINGS"]["BASKET_STEP"]?>" data-max-quantity="<?=$arResult["CATALOG_QUANTITY"]?>" data-enable-trace="<?=(($arResult["CATALOG_QUANTITY_TRACE"] == "Y" && $arResult["CATALOG_CAN_BUY_ZERO"] == "N") ? "Y" : "N")?>" max="9999"><a href="#" class="catalogPlus"></a>
			        </div>

	...
	<div id="personalCart">
		...
		<div id="basketTopLine">
			<div id="tabsControl">
				...
				<div class="item"><a href="<?=SITE_DIR?>personal/cart/order/" class="selected"><?=GetMessage("BASKET_TABS_ORDER_MAKE")?></a></div>
										...
										<ul class="userProp">
											<?foreach ($arResult["PROPERTIES"][$groupIndex] as $arProperty):?>
												<?if($arProperty["IS_EMAIL"] == "Y"){
													...
													$arProperty["DEFAULT_VALUE"] = trim($arResult["USER"]["LAST_NAME"]." ".$arResult["USER"]["NAME"]." ".$arResult["USER"]["SECOND_NAME"]);
												}

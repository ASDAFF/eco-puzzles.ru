...
<?
	...
	$arTransParams = array(
		...
		'INIT_MAP_LON' => floatval($arResult['POSITION']['yandex_lon']),
		'INIT_MAP_LAT' => floatval($arResult['POSITION']['yandex_lat']),
		'INIT_MAP_SCALE' => intval($arResult['POSITION']['yandex_scale']),
		'MAP_WIDTH' => $arParams['MAP_WIDTH'],
		'MAP_HEIGHT' => $arParams['MAP_HEIGHT'],
		"YANDEX_VERSION" => $arParams["YANDEX_MAP_VERSION"],
		"DEV_MODE"=>"Y",

...
?><div id="<? echo $templateData['TABS_ID']; ?>" class="bx-catalog-tab-section-container"<?=isset($arResult["WIDTH"]) ? ' style="width: '.$arResult["WIDTH"].'px;"' : ''?>>
	<div class="similar-to-a-similar">
		<ul class="bx-catalog-tab-list"><?
			...
			unset($tabId, $arTab);
		?></ul>
		<div class="active-link open-form-with-comments"><?=GetMessage("IBLOCK_CSC_ADD_COMMENT")?></div>
	</div>
	<div class="bx-catalog-tab-body-container">
		<div class="bx-catalog-tab-container bx-catalog-tab-container-no-padding"><?=$content?></div>
	</div>
</div>
<?

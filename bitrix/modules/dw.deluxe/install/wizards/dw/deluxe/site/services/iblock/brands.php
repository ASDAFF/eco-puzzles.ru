...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/brand.xml";
$iblockCode = "7_".WIZARD_SITE_ID; 
$iblockType = "info";
...
else
{
	...
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/brands/index.php", array("BRANDS_IBLOCK_TYPE" => "info"));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("BRANDS_IBLOCK_TYPE" => "info"));
	
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/brands/index.php", array("BRANDS_IBLOCK_ID" => $iblockID));

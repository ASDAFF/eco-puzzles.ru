...
<thead><tr><td colspan="2"><h3 class="first"><?echo GetMessage("subscr_title_confirm")?></h3></td></tr></thead>
<tr valign="top">
	<td width="40%">
		<div class="lb"><?echo GetMessage("subscr_conf_code")?><span class="starrequired">*</span></div>

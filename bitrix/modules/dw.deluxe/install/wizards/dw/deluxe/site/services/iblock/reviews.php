...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/review.xml";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/index.php", array("REVIEW_IBLOCK_TYPE" => $iblockType));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/index.php", array("REVIEW_IBLOCK_ID" => $iblockID));
?>
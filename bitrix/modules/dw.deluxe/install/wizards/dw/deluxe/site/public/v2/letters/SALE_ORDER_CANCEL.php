<div style="background-color:#f3f3f3;padding-top:24px;padding-bottom:24px;margin:0;font-family:'Arial',sans-serif;">
	<div style="min-width:600px;max-width:600px;margin:auto;">
		...
		<div style="padding-top:18px;padding-right:24px;padding-bottom:24px;padding-left:24px;background-color:#ffffff;">
			...
			<div style="margin-top:24px;margin-bottom:20px;padding-top:32px;padding-left:24px;padding-bottom:34px;padding-right:24px;font-weight:bold;font-family:'Arial Bold',Gadget,sans-serif;font-size:24px;line-height:30px;text-align:center;color:#000000;background:#f3f3f3;">Заказ номер #ORDER_ID# от #ORDER_DATE# отменен.</div>
			<div style="font-weight:normal;font-family:'Arial',sans-serif;font-size:14px;line-height:18px;color:#000000;">Причина отмены заказа:</div>
			<div style="font-weight:normal;font-family:'Arial',sans-serif;font-size:14px;line-height:18px;color:#000000;">#ORDER_CANCEL_DESCRIPTION#</div><br/>
			<div style="font-weight:normal;font-family:'Arial',sans-serif;font-size:14px;line-height:18px;color:#000000;">Для получения подробной информации по заказу пройдите в личный кабинет сайта</div><br/>

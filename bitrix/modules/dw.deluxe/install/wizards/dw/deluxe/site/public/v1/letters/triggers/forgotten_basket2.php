<div style="background-color:#f3f3f3;padding-top:24px;padding-bottom:24px;margin:0;font-family:'Arial',sans-serif;">
	<div style="min-width:600px;max-width:600px;margin:auto;">
		...
		<div style="padding-top:18px;padding-right:24px;padding-bottom:24px;padding-left:24px;background-color:#ffffff;">
			...
			<div style="margin-bottom:8px;font-weight:bold;font-family:'Arial Bold',Gadget,sans-serif;font-size:20px;line-height:26px;color:#000000;">Мы отложили для Вас забытые в корзине товары на сайте #SITE_NAME#</div>
			<div style="font-weight:normal;font-family:'Arial',sans-serif;font-size:14px;line-height:18px;color:#000000;">Вы положили несколько товаров в корзину, но так и не оформили заказ.</div>
			<div style="margin-top:12px;margin-bottom:12px;padding-top:22px;padding-right:24px;padding-bottom:20px;padding-left:24px;border:1px solid #f3f3f3;text-align:center;font-weight:bold;font-family:'Arial Bold',Gadget,sans-serif;font-size:14px;line-height:18px;color:#63c322;">На всякий случай мы отложили выбранные товары, чтобы, когда вы решите завершить покупку, вам не пришлось ждать.</div>
			<div style="font-weight:normal;font-family:'Arial',sans-serif;font-size:14px;line-height:21px;color:#000000;">Все уже готово к отправке! Мы заботимся о том, чтобы вы получили желаемое как можно скорее! Если у вас остались какие-либо вопросы – не стесняйтесь связаться с нами любым удобным способом.</div>
				...
				<tbody>
					...
					<tr>
						<td style="width:88px;padding-top:6px;padding-right:6px;padding-bottom:6px;padding-left:6px;text-align:center;border-top:1px solid #f3f3f3;vertical-align:middle;">
							<a href="#" target="_blank"><img src="http://dw-deluxe.ru/new-pages/images/services-img2.png" style="display: inline-block;max-height:90%;max-width:90%;width:auto;height:auto;" alt="Some alt"></a>
						</td>
					...
					<tr>
						<td style="width:88px;padding-top:6px;padding-right:6px;padding-bottom:6px;padding-left:6px;text-align:center;border-top:1px solid #f3f3f3;vertical-align:middle;">
							<a href="#" target="_blank"><img src="http://dw-deluxe.ru/new-pages/images/services-img4.png" style="display: inline-block;max-height:90%;max-width:90%;width:auto;height:auto;" alt="Some alt"></a>
						</td>
						<td style="padding-top:18px;padding-right:6px;padding-bottom:18px;padding-left:6px;text-align:left;border-top:1px solid #f3f3f3;vertical-align:middle;">

...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/reviews_store.xml";
$iblockCode = "52_".WIZARD_SITE_ID; 
$iblockType = "service";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/reviews/index.php", array("REVIEW_MAGAZINE_IBLOCK_TYPE" => $iblockType));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/reviews/index.php", array("REVIEW_MAGAZINE_IBLOCK_ID" => $iblockID));
?>
...
class SelectTemplateStep extends CSelectTemplateWizardStep
{
	...
	function OnPostForm()
	{
		...
		{
			$arTemplates = array("dresscode", "dresscodeV2");
			...
			// if (in_array($templateID,  array("dresscode", "dresscodeV2")))
	...
	function ShowStep()
	{
		...
		if (in_array("dresscode", array_keys($arTemplates))){
			$arTemplateOrder[] = "dresscode";
		}

		if (in_array("dresscodeV2", array_keys($arTemplates))){
			$arTemplateOrder[] = "dresscodeV2";
		}

		$defaultTemplateID = COption::GetOptionString("main", "wizard_template_id", "dresscode", $wizard->GetVar("siteID"));
		if (!in_array($defaultTemplateID, array("dresscode"))) $defaultTemplateID = "dresscode";
		...
		$arTemplateInfo = array(
			"dresscode" => array(
				...
				"DESCRIPTION" => "",
				"PREVIEW" => $wizard->GetPath()."/site/templates/dresscode/preview.gif",
				"SCREENSHOT" => $wizard->GetPath()."/site/templates/dresscode/screen.gif",
			),
			"dresscodeV2" => array(
				"NAME" => GetMessage("WIZ_TEMPLATE_ADAPT_HORIZONTAL"),
				"DESCRIPTION" => "",
				"PREVIEW" => $wizard->GetPath()."/site/templates/dresscodeV2/preview.gif",
				"SCREENSHOT" => $wizard->GetPath()."/site/templates/dresscodeV2/screen.gif",
			),
		);

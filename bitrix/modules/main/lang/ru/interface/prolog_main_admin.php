...
$MESS["prolog_main_timelimit11"] = "<span class=\"required\">Внимание!</span> Срок действия текущей лицензии заканчивается через #DAYS_AGO# дней. В срок до #FINISH_DATE# необходимо приобрести продление лицензии на следующий год во избежание блокировки продукта. Свяжитесь с <a href=\"mailto:enterprise@1c-bitrix.ru\">отделом по работе с ключевыми клиентами компании 1С-Битрикс</a>. ";

...
$MESS['IPOLSDEK_OPT_numberOfShtrihs'] = "Число копий штрихкодов на листе <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-numberOfShtrihs\", this);'></a>";
$MESS['IPOLSDEK_OPT_formatOfShtrihs'] = "Формат печати штрихкодов";
...
$MESS ['IPOLSDEK_OPT_noYmaps'] = "Не подключать Яндекс-карты <a href='#' class='PropHint' onclick='return IPOLSDEK_setups.popup(\"pop-noYmaps\", this);'></a>";
	// Оформление заказа
...
$MESS ['IPOLSDEK_HELPER_numberOfShtrihs'] = "Форма квитанции для заказа присылается сервером СДЭК в формате pdf. Если сервер не сможет уместить указанное количество копий на одном листе А4 - они будут разбиты на несколько листов.";
$MESS ['IPOLSDEK_HELPER_numberOfPrints'] = "Штрихкоды для мест заказа присылаются сервером СДЭК в формате pdf. Если сервер не сможет уместить указанное количество копий на одном листе указанного формата - они будут разбиты на несколько листов.";
		// НДС
...
<div class='ipol_subFaq'>
	<a class='ipol_smallHeader' onclick='$(this).next().toggle(); return false;'>&gt; Изменение приоритета расчета тарифов.</a>
	<div class='ipol_inst'>
...
function handleGoods(&\$arTarifPriority,\$profile){
...
<p><strong>Проблемы в административной части</strong></p>
	...
	<div class='ipol_subFaq'>
		<a class='ipol_smallHeader' onclick='$(this).next().toggle(); return false;'>&gt; В накладной указано \"Тестовый заказ\".</a>
		<div class='ipol_inst'>
		Заказ отправлен с тестового аккаунта. Отзовите заявку, авторизуйтесь под боевыми доступами, отправленными вам на почту на запрос подключения к Интеграции, и отправьте заявку повторно.
		</div>
	</div>

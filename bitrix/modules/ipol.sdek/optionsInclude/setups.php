...
<?
foreach(array("depature","showInOrders","realSeller","addDeparture","shipments","prntActOrdr","numberOfPrints","numberOfShtrihs","NDSUseCatalog","address","pvzPicker","noPVZnoOrder","hideNal","hideNOC","autoSelOne","noYmaps","profilesMode","cntExpress","mindEnsure","AS","noVats","statusSTORE","statusTRANZT","statusCORIER","tarifs","warhouses","dostTimeout","timeoutRollback","TURNOFF","TARSHOW","autoAddCities") as $code)

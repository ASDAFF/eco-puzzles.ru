					...
					<div class="landing-block-node-inner-container-left js-animation fadeInLeft w-100 u-bg-overlay__inner g-py-100">
						...
						<div class="landing-block-node-title-container g-brd-primary g-mb-30">
							<div class="landing-block-node-border-container g-brd-inherit g-brd-left g-brd-left-none--md g-brd-right--md g-brd-7 g-pl-30 g-pr-30 g-pl-0--lg">
								<h2 class="landing-block-node-title landing-block-node-title-left g-color-white text-uppercase g-line-height-0_9 g-font-weight-700 g-font-size-76 mb-0">
									Interior<br>works
								</h2>
							</div>
						</div>
						<div class="landing-block-node-button-container">
							<a class="btn btn-lg u-btn-inset mx-2 landing-block-node-button" href="#">Read more</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="landing-block-node-inner-container-right js-animation fadeInRight w-100 u-bg-overlay__inner g-py-100">
						...
						<div class="landing-block-node-title-container g-brd-primary g-mb-30">
							<div class="landing-block-node-border-container g-brd-inherit g-brd-left g-brd-7 g-pl-30">
								<h2 class="landing-block-node-title landing-block-node-title-right g-color-white text-uppercase g-line-height-0_9 g-font-weight-700 g-font-size-76 mb-0">
									Exterior<br>works
								</h2>
							</div>
						</div>

...
foreach ($arResult["OFFER"] as $num => &$arOffer)
{
    ...
    $arOffer["DISPLAY_PROPERTIES"][$arParams[$code]]["DISPLAY_VALUE"] = $arOffer["DISPLAY_PROPERTIES"][$arParams[$code]]["VALUE_ENUM"] ? strip_tags ($arOffer["DISPLAY_PROPERTIES"][$arParams[$code]]["VALUE_ENUM"]) : strip_tags($arOffer["DISPLAY_PROPERTIES"][$arParams[$code]]["DISPLAY_VALUE"]);

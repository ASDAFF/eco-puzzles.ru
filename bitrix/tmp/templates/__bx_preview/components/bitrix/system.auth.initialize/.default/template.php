...
<?if($arResult["SHOW_FORM"]):?>
	...
	<?=bitrix_sessid_post()?>
		<table class="data-table bx-confirm-table">
			...
			?>
			<tr>
				<td colspan="2"><label for="USER_REMEMBER">&nbsp;<?=GetMessage("CT_MAIN_REG_INIT_REMEMBER_TITLE")?></label><input type="checkbox" id="USER_REMEMBER" name="USER_REMEMBER" value="Y"<?=$checked?>/></td>
			</tr>
			...
			<tr>
				<td colspan="2"><input type="submit" name="confirm" class="submit" value="<?echo GetMessage("CT_MAIN_REG_INIT_CONFIRM")?>" /></td>
			</tr>
		</table>
